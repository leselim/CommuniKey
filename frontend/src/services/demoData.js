...
export const members = [
  {
    ...
    emergency_role: 'Chief Safety Coordinator & Estate Admin',
  ...
  },
  {
    ...
    household_vehicle: 'White Tesla Model 3 (Reg: SYS 99 GP)',
    gate_access_code: 'GATE-SYS-002',
    emergency_notes: 'Platform infrastructure coordinator.',
    events_attended: 18,
  },
  {
    id: 3,
    ...
    emergency_role: 'Section B Night Patrol Lead',
    household_vehicle: 'Dark Blue Mazda CX-5 (Reg: SJ 08 GP)',
    gate_access_code: 'GATE-VOL-034',
    emergency_notes: 'First aid certified responder. Back gate access authorization.',
    events_attended: 16,
  },
  {
    id: 4,
    ...
    emergency_role: 'Designated Block Watcher (Section A)',
    household_vehicle: 'Silver Volkswagen Polo (Reg: AB 42 CD GP)',
    gate_access_code: 'GATE-KEY-8841',
    emergency_notes: 'Pets on property (2 dogs in back yard). Preferred contact: SMS & Direct Chat.',
    events_attended: 12,
  },
  {
    id: 5,
    ...
    last_name: 'Rostova',
    role: 'Resident',
    email: 'elena.r@riverside.co.za',
    phone_number: '+27 84 321 6540',
    address: '16 Mill Road, Section B',
    status: 'Verified',
    joined_date: 'June 2025 (14 Months)',
    emergency_role: 'Community Event Organizer',
    household_vehicle: 'Grey Hyundai Tucson (Reg: ER 16 GP)',
    gate_access_code: 'GATE-KEY-5592',
    emergency_notes: 'Clubhouse committee member.',
    events_attended: 9,
  },
];
